...
def train_one_epoch(model, train_loader, optimizer, args, train=True):
    # global have_print
...
def main():
    ...
    ckpt_folder='/home/siyich/byol-pytorch/checkpoints_ddp_mlp_bnl%s_pbnl%s_ns%s/ema%s_mse%s_std%s_cov%s_po%s_hid%s_prj%s_sym%s_closed%s_sequential%s_lr%s_wd%s' \
...
def main_worker(gpu, args):
    ...
    for i in epoch_list:
        ...
        test_loss = train_one_epoch(model, test_loader, optimizer, args, False)
