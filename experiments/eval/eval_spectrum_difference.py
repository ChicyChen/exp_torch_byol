...
def main():
    ...
    if args.byol:
        ...
        ssl_evaluator = Spectrum_Difference(model=model.module.encoder, device=cuda, input_num=args.input_num)
    ...
    ssl_evaluator.visualize(loader = train_loader, fpath=ckpt_folder, epoch_num = args.epoch_num)
    print("train diff visualized")
    ssl_evaluator.visualize(loader = test_loader, fpath=ckpt_folder, epoch_num = args.epoch_num, mode='val')
