...
import argparse
sys.path.append("/home/siyich/byol-pytorch/pcnet_v2")
...
# python -m torch.distributed.launch --nproc_per_node=8 experiments/3dseq_v2/3dseq_pcnet_vic_slow50.py
...
def main():
    ...
    ckpt_folder='/home/siyich/byol-pytorch/checkpoints_%s_slow50_sub%s/hid%s_hidpre%s_prj%s_prl%s_pre%s_np%s_pl%s_il%s_ns%s/mse%s_std%s_cov%s_sym%s_closed%s/bs%s_lr%s_wd%s' \
